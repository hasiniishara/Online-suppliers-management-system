...
class OderStatus extends Component{
            ...
            this.state.proArr.map((item, i) => {
                return (
                  <Card key={i} title={item.type}>
                    ...
                    {(item.state === 'reject')?(<Text style={styles.txtReject}>Order State : {item.state}</Text>):
                      ((item.state === 'accept')?(<Text style={styles.txtAccept}>Order State : {item.state}</Text>):
                        (<Text style={styles.txtPending}>Order State : {item.state}</Text>))}
                  </Card>
                );
              })
        }
