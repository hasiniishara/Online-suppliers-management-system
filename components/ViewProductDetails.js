...
class ViewProductDetails extends Component{
    constructor() {
        ...
        this.state = {
          isLoading: true,
          proArr: [],
          //sendE:this.props.navigation.state.params.emailArray
        };
    }
    componentDidMount() {
    ...
    getCollection = (querySnapshot) => {
      ...
      console.log(JSON.parse(navigation.getParam('emailArray')));
     /* if((JSON.parse(navigation.getParam('emailArray'))) === 'admin1234@gmail.com'){
       // console.log(JSON.parse(navigation.getParam('emailArray')));
        const proArr = [];
        ...
        console.log(mail);
        console.log('helo dev');
        querySnapshot.forEach((res) => {
          const { name, email, mobile, price, address } = res.data();
          console.log(res.data().email);
          if(res.data().email.trim() == mail.trim() ){
            console.log('t');
